...
<div class="col-md-6 col-sm-6 sign-in">
    ...
    <form class="register-form outer-top-xs" role="form" method="POST" action="{{ isset($guard) ? url($guard.'/login') : route('login') }}">
        ...
        <div class="radio outer-xs">
            <label>
                <input type="radio" id="remember_me" name="remember" name="optionsRadios">Remember me!
            </label>
...
<div class="col-md-6 col-sm-6 create-new-account">
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" id="phone" name="phone" value="{{old('phone')}}" class="form-control unicase-form-control text-input">
            @error('phone')
            <span class="invalid-feedback" role="alert">
                <strong>{{ $message }}</strong>
            </span>
